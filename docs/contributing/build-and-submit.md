...
- **The Plugin Dev Tools installed:**
  ...
  /plugin install plugin-docs-lint@Larkin-Jainschigg-Marketplace
  /plugin install plugin-security-check@Larkin-Jainschigg-Marketplace
...
- **Users pick it up** with `/plugin marketplace update Larkin-Jainschigg-Marketplace`, then `/plugin install <your-plugin>@Larkin-Jainschigg-Marketplace`.
