...
```
/plugin install discourse-tracker@claude-plugins
```
...
```
~/.claude/plugins/discourse-tracker-claude-plugins/skills/update-discourse/sources.md
```
...
Skills that benefit most: content ideation, competitive analysis, market positioning, anything where "what's happening right now" matters.
