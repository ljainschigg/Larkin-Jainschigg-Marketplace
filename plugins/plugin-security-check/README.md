...
- If it has external runtime dependencies (MCP server, or shells out to a system binary), it has a `setup` skill or equivalent inline preflight matching its README's Prerequisites (`CONVENTIONS.md` §5)
