...
- Whether it shells out to any other system binary beyond the MCP runtime (`git`, `gh`, `ffmpeg`, a browser, etc.)
...
└── skills/
    └── setup/
        └── SKILL.md          # runtime + MCP-tool preflight check (see CONVENTIONS.md §5)
```
